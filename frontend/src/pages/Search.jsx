  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-xl font-bold text-gray-900">Tìm kiếm trực tiếp từ Tiki</h1>
        <WorkerStatus />
      </div>
      ...
      {phase === "crawling" && (
        <div className="text-center py-16 text-gray-400">
          ...
          <p className="text-sm">Đang cào và phân tích từ Tiki...</p>
      ...
      {phase === "done" && results.length > 0 && (
        <div>
          <p className="text-sm text-emerald-600 bg-emerald-50 px-4 py-2.5 rounded-xl mb-4 border border-emerald-100">✓ Tìm thấy và phân tích {results.length} sản phẩm từ Tiki</p>
